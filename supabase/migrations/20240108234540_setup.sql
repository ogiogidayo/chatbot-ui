...
AS $$
DECLARE
  project_url TEXT := 'https://odpbbimfhlnhtzqcvren.supabase.co';
  service_role_key TEXT := 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6Im9kcGJiaW1maGxuaHR6cWN2cmVuIiwicm9sZSI6InNlcnZpY2Vfcm9sZSIsImlhdCI6MTcwOTgxMzU2MywiZXhwIjoyMDI1Mzg5NTYzfQ.ZljTIotWWP37ojV9UN-SSIkBoSW9SGhp0AYNjrFypZE'; -- full access needed for http request to storage
